...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const refreshTicketsCount = async (retry = 0) => {
    try {
      ...
      setBadge(document.getElementById("tickets-count-pill") as HTMLElement | null, count);
      ...
      if (retry < 2) {
        ...
        setBadge(document.getElementById("tickets-count-pill") as HTMLElement | null, 0);
      }
    }
  };
